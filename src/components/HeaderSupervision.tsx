...
interface HeaderSupervisionProps {
  user: {
    name: string;
    email: string;
    role: string;
...
export function HeaderSupervision({ user, onLogout }: HeaderSupervisionProps) {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-blue-700">Admin Supervision</span>
            </div>
            <span className="text-xs text-gray-600">Dashboard Interventions Techniques</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-2 bg-blue-50 px-3 py-2 rounded-lg">
            ...
            <div className="text-xs">
              <p className="font-medium text-blue-900">12 interventions</p>
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center space-x-2 px-3">
                ...
                <div className="hidden md:flex flex-col items-start">
                  ...
                  <span className="text-xs text-gray-500">Admin Technique</span>
                </div>
              </Button>
            </DropdownMenuTrigger>
